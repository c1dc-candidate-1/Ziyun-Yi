...
avg=avg.sort_values(by='avg_amount',ascending=False)
...
#Loan Type & State:
t1=loan_dataset.groupby(['Loan_Type_Description','State'])['Loan_Amount_000'].sum().to_frame().reset_index()
t=t1.sort_values(by='Loan_Amount_000',ascending=False)
trace1=go.Bar(x=t[t['State']=='VA']['Loan_Type_Description'],y=t[t['State']=='VA']['Loan_Amount_000'],name='VA')
trace2=go.Bar(x=t[t['State']=='MD']['Loan_Type_Description'],y=t[t['State']=='MD']['Loan_Amount_000'],name='MD')
trace3=go.Bar(x=t[t['State']=='DC']['Loan_Type_Description'],y=t[t['State']=='DC']['Loan_Amount_000'],name='DC')
trace4=go.Bar(x=t[t['State']=='WV']['Loan_Type_Description'],y=t[t['State']=='WV']['Loan_Amount_000'],name='WV')
trace5=go.Bar(x=t[t['State']=='DE']['Loan_Type_Description'],y=t[t['State']=='DE']['Loan_Amount_000'],name='DE')
data_t=[trace1,trace2,trace3,trace4,trace5]
py.offline.plot({
          "data": data_t
         ,"layout": go.Layout( barmode='stack',xaxis=XAxis(title='Loan Type'), 
             yaxis=YAxis(title='Loan_Amount_000'))})
